...
import { RideType, VehicleType, WithdrawalRequestType } from "../types/api/mainApi.type";
...
export const VehicleDetails = ({ data }: { data: VehicleType }) => {
  ...
  const { data: todayEarning, isLoading } = useQuery({
                ...
                <div className="bg-[#F3F7F5] rounded-lg h-18 w-24">
                  <div className="flex items-start flex-col p-2">
                    ...
                    <div className="py-3">
                      ...
                      <span className="text-[9px]">42h 32m</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full">
                  <div className="pb-4">
                    <div className="flex justify-between w-full pt-3 cursor-pointer" onClick={() => setEOpen(!eOpen)}>
                      <h4> Earnings</h4>
                      <span className="font-semibold flex items-center ">
                        ₦<span className="pr-1">{data.earning}</span>
                        <Icon
