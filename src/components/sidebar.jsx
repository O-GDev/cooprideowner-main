...
function Sidebar() {
  ...
  return (
    <div>
        ...
        <div className={`bg-white flex flex-col lg:w-80 h-screen shadow-md ${menuOpen ? 'w-80' : 'w-16'} transition-transform duration-100 delay-75`}>
    <div className='p-2'>
    <div className={`text-[19px] lg:hidden ${menuOpen ? "flex" : "hidden"} justify-end`}>
        <div className="cursor-pointer bg-white rounded-full p-1 shadow-md" onClick={() => setMenuOpen(false)}>
            <Icon icon="iconoir:cancel" width="1em" height="1em" className='z-50 flex justify-center items-center' />
            </div>
            </div>
    </div>
   <div className='flex flex-col justify-between h-full'>
     ...
     <div className={`flex justify-center pt-5 items-center lg:hidden`}>
        {menuOpen ? <img src={logo} className='w-44 justify-center' />:
        <Icon onClick={() => setMenuOpen(true)} className='lg:hidden' icon="material-symbols-light:menu" width="1.8em" height="1.8em"  style={{color: '#616161'}} />
        }</div>
    ...
    <div className={`${location.pathname == "/dashboard" ? "text-green" : "text-[#616161] "} flex`}>
        <Icon icon="solar:home-2-bold" width="1.8em" height="1.8em" className={current ? 'bg-[#119001]' : ''} />
        ...
        <Icon icon="fluent:vehicle-cab-16-regular" width="1.8em" height="1.8em" className={current ? 'bg-[#119001]' : ''} />
        ...
        <div className={`${location.pathname == "/transactionhistory" ? "text-green" : "text-[#616161] "} flex`}>
        <Icon icon="material-symbols:history" width="1.8em" height="1.8em" className={current ? 'bg-[#119001]' : ''} />
        ...
        <Icon icon="clarity:settings-line" width="1.8em" height="1.8em" className={current ? 'bg-[#119001]' : ''} />
    ...
    <div className='relative bottom-12'>
        ...
        <div className='text-[#616161] flex items-center'>
            <span className='w-12 h-12 rounded-full bg-[#D9D9D9]'></span>
